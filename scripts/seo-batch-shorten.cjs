...
const TITLE_PATTERNS = [
  ...
  // Wave 2 patterns
  [/\s+Nederland\s+2026/g, ' NL 2026'],
  [/\s+— Bereken uw Besparing met AI Automatisering/g, ' — Besparing'],
  [/\s+— Voice AI, SIP, Latency, Stem/g, ''],
  [/\s+— 25-punts compliance check \(gratis\)/g, ' — gratis check'],
  [/\s+— Servicemonteur Routing/g, ''],
  [/\s+Wat is het Verschil\?\s+/g, ': '],
  [/\s+— De \d+ Beste Categorieen in 2026/g, ' (2026)'],
  [/\s+Lead Kwalificatie, Bezichtigingen & CRM-Integratie/g, ''],
  [/\s+— Automatische Agendabeheer/g, ''],
  [/\s+— 24\/7 Klantenservice/g, ''],
  [/\s+— Vacatures & Screening Automatiseren/g, ''],
  [/: Telefoon, Chat & WhatsApp/g, ''],
  [/: Automatisch Leads Kwalificeren/g, ''],
  [/: Artikelen, Landingspaginas & Blogs/g, ''],
  [/: Automatisch Posts & Reacties/g, ''],
  [/: Automatisch Prospects Bellen & Opvolgen/g, ''],
  [/Custom AI Workflows & Automatisering op Maat voor MKB/g, 'Custom AI Workflows op Maat MKB'],
  [/AI WhatsApp Bot voor MKB Nederland/g, 'AI WhatsApp Bot MKB'],
  [/AI Receptionist & AI Telefoniste voor MKB Nederland/g, 'AI Receptionist & Telefoniste MKB'],
  [/AI Telefoon Assistent voor MKB Nederland/g, 'AI Telefoon Assistent MKB'],
  [/AI-Website Bundel MKB Nederland/g, 'AI-Website Bundel MKB'],
  [/Webshop Laten Maken Nederland/g, 'Webshop Maken NL'],
  [/Website Laten Maken MKB Nederland/g, 'Website Maken MKB'],
  [/AI-ready Webdesign/g, 'AI Webdesign'],
  [/\s+— Bepaal uw AI-volwassenheid in 3 minuten/g, ''],
  [/\s+vaste prijs €[\d.]+, oplevering in \d+ dagen/g, ''],
  [/\s+\(Stap-voor-Stap\)/g, ''],
  [/\s+\(2026 Prijzen\)/g, ' (2026)'],
  [/Hoe Automatiseer je Je Facturering met AI\?/g, 'AI facturering automatisering'],
  [/Hoeveel Kost een AI Agent in Nederland\?/g, 'AI agent kosten NL'],
];
