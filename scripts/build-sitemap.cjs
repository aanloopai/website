...
// (the source file is skipped by isDynamicRoute, so add the outputs explicitly).
for (const s of ['horeca', 'accountancy', 'zorg', 'vastgoed', 'bouw', 'advocatuur', 'logistiek', 'detailhandel']) {
